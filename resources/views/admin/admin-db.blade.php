  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-md-2 sidebar position-sticky sticky-top">
        ...
        <h5 class="text-center text-success mb-4">KHETIBOOK</h5>
        <a href="#" class="active"><i class="fa-solid fa-users"></i><span> All Users</span></a>
        <a href="{{ route('admin.allcrops')}}" class="disabled-link"><i class="fa-solid fa-wheat-awn"></i><span> Crop Data</span></a>
